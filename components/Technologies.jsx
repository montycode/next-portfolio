...
const Technologies = () => {
    return (
        <section id="technologies" className="p-4 md:py-10 md:px-20 dark:bg-gradient-to-r dark:from-gray-900 dark:to-slate-800">
            <div className="mx-auto container py-12 px-4 lg:px-0 space-y-4">
                ...
                <div className="flex flex-wrap md:mt-16 mt-8 gap-6 flex items-center justify-between">
                    <div className='p-4 rounded transition duration-300 ease-in-out hover:shadow hover:shadow-xl cursor-pointer  hover:bg-gray-900'>
